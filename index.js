...
async function connectToWA() {
  console.log("Connecting Levantre x pro MD");
  ...
  danuwa.ev.on('connection.update', async (update) => {
    ...
    if (connection === 'close') {
      ...
      console.log('Levantre x pro MD Connected To WhatsApp');
...
app.get("/", (req, res) => {
  res.send("Levantre x pro MD  Started");
});
